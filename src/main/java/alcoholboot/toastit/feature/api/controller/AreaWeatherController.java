...
//        log.info("모델에 담아 보내는 Geocoding API KEY : "+geocodingApiKey);
    ...
    public Map<String, Object> saveCoordinates(@RequestBody Map<String, Double> coordinates) throws UnsupportedEncodingException, URISyntaxException, JsonProcessingException {
        ...
        // 모델에 넣기
//        model.addAttribute("temperature", t1h);
//        model.addAttribute("weatherInfo", weather);
//        model.addAttribute("cocktailInfo", cocktails.get(randomInt).getStrDrink());

        // 출력해보기
        //System.out.println("temperature: " + t1h + ", weatherInfo: " + weather + ", cocktailInfo : " + cocktails.get(randomInt).getStrDrink());
